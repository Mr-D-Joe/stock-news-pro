...
import type { Metric, DataOrigin, SanitizationTrace } from '../../types';
...
export const SummarizerCard: React.FC<SummarizerCardProps> = ({ summary, metrics, dataOrigin, sanitization }) => {
    return (
